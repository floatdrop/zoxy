...
pub fn build(b: *std.Build) void {
    ...
    mod.addCSourceFiles(.{
        ...
        .files = &.{
            ...
            //"LPdir_win32.c",
            //"LPdir_wince.c",
            //"aes/aes_cbc.c", // x86_64: aes-x86_64.s
            "aes/aes_cfb.c",
            //"aes/aes_x86core.c",
            //"aes/aes_core.c",
            "aes/aes_ecb.c",
            ...
            "bn/asm/x86_64-gcc.c",
            "bn/bn_add.c",
            //"bn/bn_asm.c", // x86_64: bn/asm/x86_64-gcc.c
            "bn/bn_blind.c",
            "bn/bn_const.c",
            "bn/bn_conv.c",
            "bn/bn_ctx.c",
            ...
            "buffer/buf_err.c",
            "buffer/buffer.c",
            //"camellia/camellia.c", // x86_64: cmll-x86_64.s
            //"camellia/cmll_cbc.c", // x86_64: cmll-x86_64.s
            "camellia/cmll_cfb.c",
            "camellia/cmll_ctr.c",
            "camellia/cmll_ecb.c",
            ...
            "cast/c_ofb64.c",
            "cast/c_skey.c",
            //"chacha/chacha_enc.c", // x86_64: chacha-x86_64.s
            //"chacha/chacha_ppc.c",
            ...
            "des/fcrypt.c",
            "des/fcrypt_b.c",
            //"des/ncbc_enc.c", // x86-asm variant only; des_enc.c defines DES_ncbc_encrypt
            "des/ofb64ede.c",
            "des/ofb64enc.c",
            "des/ofb_enc.c",
            "des/pcbc_enc.c",
            ...
            "lhash/lh_stats.c",
            "lhash/lhash.c",
            //"loongarchcap.c", // loongarch only; collides with x86_64cpuid.s
            //"md2/md2_dgst.c",
            //"md2/md2_one.c",
            "md4/md4_dgst.c",
            "md4/md4_one.c",
            ...
            "rc2/rc2cfb64.c",
            "rc2/rc2ofb64.c",
            //"rc4/rc4_enc.c", // x86_64: rc4-x86_64.s
            //"rc4/rc4_skey.c", // x86_64: rc4-x86_64.s
            //"rc5/rc5_ecb.c",
            //"rc5/rc5_enc.c",
            //"rc5/rc5_skey.c",
            //"rc5/rc5cfb64.c",
            ...
            "seed/seed_ofb.c",
            "self_test_core.c",
            //"sha/keccak1600.c", // x86_64: keccak1600-x86_64.s
            "sha/sha1_one.c",
            "sha/sha1dgst.c",
            "sha/sha256.c",
            "sha/sha3.c",
            ...
            "ui/ui_util.c",
            "uid.c",
            //"whrlpool/wp_block.c", // x86_64: wp-x86_64.s
            "whrlpool/wp_dgst.c",
            "x509/by_dir.c",
            "x509/by_file.c",
            "x509/by_store.c",
